...
#ifdef _DEBUG
#define BLOCK_MODEL_PATH "F:/Python/TMTrackNN2/models/tech/tmp/block_model.pb"
#define POSITION_MODEL_PATH "F:/Python/TMTrackNN2/models/tech/tmp/position_model.pb"
#define PATTERN_DATA_PATH "F:/Python/TMTrackNN2/pattern_data.json"
#define TF_PATH "C:/tensorflow/tensorflow.dll"
#define SAVEGBX_PATH "F:/Python/SaveGBX/dist/savegbx/savegbx.exe"
#define TEMPLATE_PATH "F:/Python/TMTrackNN2/data/Template.Challenge.Gbx"
